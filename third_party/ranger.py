...
# Credits:
# Gradient Centralization --> https://arxiv.org/abs/2004.01461v2 (a new
# optimization technique for DNNs), github:
...
# summary of changes:
# 4/11/20 - add gradient centralization option.  Set new testing benchmark for
# accuracy with it, toggle with use_gc flag at init.
...
class Ranger(Optimizer):
    def __init__(
        ...
        alpha=0.5,
        k=6,
        N_sma_threshold=5,  # Ranger options
        betas=(0.95, 0.999),
        eps=1e-5,
        weight_decay=0,  # Adam options
        # Gradient centralization on or off, applied to conv layers only or
        # conv + fc layers
        use_gc=True,
        gc_conv_only=False,
    ):
