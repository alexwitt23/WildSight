<template>
  <aside class="menu">
    <div class="logo"><a href=".">WildSight</a></div>
    ...
    <ul class="menu-list github">
      <li>
        <a href="https://github.com/alexwitt23/WildSight" target="_blank" rel="noopener noreferrer">
          <span class="menu-item-heading"> WildSight Github</span>
        </a>
      </li>
    </ul>
  </aside>
