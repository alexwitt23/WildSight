<template>
  <nav class="navbar navbar-dark bg-dark flex-wrap">
  <div class="container-fluid">
    ...
    <a class="navbar-brand flex-grow-1" to="/">WildSight</a>
    <div class="collapse navbar-collapse flex-grow-1 justify-content-center" id="navbar1">
